# Login Page UI Documentation

This document contains the complete UI code for the ZnapFile login page with all security features and animations.

## Overview
The login page is designed to showcase security features while providing a smooth login experience. It includes:
...
import { 
  ...
  ShieldCheck, Database, Cloud, CheckCircle
} from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-b from-dark-bg via-dark-bg to-card-bg">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-20">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <form onSubmit={show2FA ? handle2FASubmit : handleSubmit} className="bg-card-bg/80 backdrop-blur rounded-2xl p-8 border border-gray-800">
              ...
              >
                {loading ? (show2FA ? 'Verifying...' : 'Signing in...') : (
                  <>
...
- Links to security features and sign up
- Backdrop blur effect for modern look

### 2. Hero Section
- Split layout with welcome message and login form
...
- Password visibility toggle
- 2FA support with code input
- Error handling with animations
- Loading states

### 4. Security Features Section
- Four main security features with icons
- Grid layout with hover effects
- Scroll-triggered animations
- Clear, concise descriptions

### 5. Trust Indicators
- Statistics showing commitment to privacy
...
## Color Scheme
- Background: Dark gradient (#050505)
...
- Custom stores and API services